...
pub mod denm_pdu_description {
    ...
    use super::etsi_its_cdd::{
        ...
        MetaInformation, MultiplicativeFactor, NumberOfOccupants, ObjectFace,
        OccupiedLanesWithConfidence, PathPredictedList, PerceivedObject, PosCentMass, PosFrontAx,
        PosLonCarr, Position1d, PositionOfOccupants, PositionOfPillars, PositioningSolutionType,
        ReferencePosition, RequestResponseIndication, RestrictedTypes,
        RoadConfigurationSectionList, RoadType, Speed, SpeedLimit, StandardLength12b,
        StandardLength3b, StationId, StationType, StationarySince, Temperature, TimestampIts,
        Traces, TracesExtended, TrafficDirection, TrafficRule, TurningRadius,
        VehicleIdentification, VehicleMass, Wgs84Angle, WheelBaseVehicle,
    };
    ...
    #[doc = " *"]
    #[doc = " * @field lanePosition: the optional lane position of the event."]
    #[doc = " *"]
    #[doc = " * @field impactReduction: optional vehicle data for collision mitigation."]
    #[doc = " *"]
    #[doc = " * @field externalTemperature: optional the ambient temperature at the event position."]
    #[doc = " *"]
    #[doc = " * @field roadWorks: optional information of the roadwork zone."]
    #[doc = " *"]
    #[doc = " * @field positioningSolution: optionally indicates the technical solution being used by the originating ITS-S to estimate the event position."]
    #[doc = " *"]
    #[doc = " * @field stationaryVehicle: optional information about a stationary vehicle."]
    #[doc = " *"]
    #[doc = " * @field roadConfiguration: optional information about the configuration of the road."]
    #[doc = " *"]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field header: the header of the DENM PDU."]
    #[doc = " *"]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field management: the Management Container."]
    #[doc = " *"]
    #[doc = " * @field situation: the optional Situation Container."]
    #[doc = " *"]
    #[doc = " * @field location: the optional Location Container."]
    #[doc = " *"]
    #[doc = " * @field alacarte: the optional ALaCarte Container ."]
    #[doc = " *"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field heightLonCarrLeft: the height of the left longitudinal carrier of the vehicle from base to top."]
    #[doc = " *"]
    #[doc = " * @field heightLonCarrRight: the height of the right longitudinal carrier of the vehicle from base to top."]
    #[doc = " *"]
    #[doc = " * @field posLonCarrLeft: the position of the left longitudinal carrier of vehicle."]
    #[doc = " *"]
    #[doc = " * @field posLonCarrRight: the position of the right longitudinal carrier of vehicle."]
    #[doc = " *"]
    #[doc = " * @field positionOfPillars: information about the vertical support of the vehicle in which the originating ITS-S is mounted. It shall be "]
    #[doc = " * included for passenger vehicles only."]
    #[doc = " *"]
    #[doc = " * @field posCentMass: the position of the centre of mass of the vehicle."]
    #[doc = " *"]
    #[doc = " * @field wheelBaseVehicle: the wheel base of the vehicle."]
    #[doc = " *"]
    #[doc = " * @field turningRadius: the turning radius of the vehicle."]
    #[doc = " *"]
    #[doc = " * @field posFrontAx: the position of the front axle of the vehicle."]
    #[doc = " *"]
    #[doc = " * @field positionOfOccupants: indicates whether an in-vehicle seat is occupied at the moment of generation of the message."]
    #[doc = " *"]
    #[doc = " * @field vehicleMass: the mass of the unloaded vehicle"]
    #[doc = " *"]
    #[doc = " * @field requestResponseIndication: indicates whether the originating ITS-S transmitting the impactReduction component is requesting "]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field eventSpeed: optional speed of a detected dynamic event and the confidence of the speed information. "]
    #[doc = " *"]
    #[doc = " * @field eventPositionHeading: the optional heading of the event and the confidence of the heading information."]
    #[doc = " *"]
    #[doc = " * @field detectionZonesToEventPosition: the detection zone information approaching the event position, see clause 6.1.3.3."]
    #[doc = " *"]
    #[doc = " * @field roadType: the optional road type information at the event position. "]
    #[doc = " *"]
    #[doc = " * @field lanePositions: the optional lane(s) where the event is located, at the position indicated by the component eventPosition "]
    #[doc = " * of the Management container and for a given reference direction."]
    #[doc = " *"]
    #[doc = " * @field occupiedLanes: the optional lane(s) that are fully or partially occupied by the event, at the position indicated by the "]
    #[doc = " * component eventPosition of the Management container and for a given reference direction."]
    #[doc = " *"]
    #[doc = " * @field linkedIvims: the optional list of DF IvimReference, pointing to IVIMs that are semantically connected because providing information "]
    ...
    #[doc = " *"]
    #[doc = " * @field linkedMapem: the optional list of DF Mapreference, pointing to MAPEMs that are semantically connected because providing information "]
    ...
    #[doc = " * the SituationContainer component eventZone."]
    #[doc = " *"]
    #[doc = " * @field detectionZonesToSpecifiedEventPoint: the optional detection zone information approaching towards a "]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field actionId: the identifier of the DENM."]
    #[doc = " *"]
    #[doc = " * @field detectionTime: the time at which the event is detected."]
    #[doc = " *"]
    #[doc = " * @field referenceTime: the time at which a new DENM, an update DENM or a cancellation DENM is generated"]
    #[doc = " *"]
    #[doc = " * @field termination: the optional termination type of the DENM."]
    #[doc = " *"]
    #[doc = " * @field eventPosition: the geographical position used in the definition of the awareness area / relevance zone, see clause 6.1.3."]
    #[doc = " *"]
    #[doc = " * @field awarenessDistance: the optional radius of the circular awareness area, with centre at the event position or at any of the "]
    #[doc = " * event history points as defined in clause 6.1.3.1."]
    #[doc = " *"]
    #[doc = " * @field trafficDirection: the optional traffic direction along which the receiving ITS-S may encounter the event, "]
    #[doc = " * as defined in clause 6.1.3."]
    #[doc = " *"]
    #[doc = " * @field validityDuration: the validity duration of a DENM. This component represents a time offset in the unit of second since detectionTime."]
    #[doc = " *"]
    #[doc = " * @field transmissionInterval: the optional time interval for DENM transmission as defined by the originating ITS-S. "]
    ...
    #[doc = "*"]
    #[doc = " * This DE indicates whether a vehicle has perceived an event (e.g. a stationary vehicle using camera sensors) or whether it is itself the cause of the event."]
    #[doc = " * the value shall be set to:"]
    #[doc = " * - True - in case the vehicle has perceived the event"]
    #[doc = " * - False - in case the vehicle itself is the cause of the event (e.g. vehicle is stationary) or part of the cause (e.g. traffic jam) or is directly exposed to the environmental condition (e.g. adverse weather)"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash, Copy)]
    #[rasn(delegate)]
    pub struct PerceivedEvent(pub bool);
    #[doc = "* "]
    #[doc = " * This type contains detailed information about an object with which a vehicle and/or the traffic is likely to collide."]
    #[doc = " *"]
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field perceivedPreCrashObject: information about a perceived object in the East, North, Up reference frame."]
    #[doc = " *"]
    #[doc = " * @field objectStationId: the optional station Id of the object for which the information is provided."]
    #[doc = " *"]
    #[doc = " * @field timeToCollision: the optional estimated time to collision of a vehicle with the object. "]
    #[doc = " *"]
    #[doc = " * @field impactSection: indication of the object's section where the impact will most likely occur. "]
    ...
    #[doc = " *"]
    #[doc = " * @field estimatedBrakingDistance: the optional estimated distance in which the vehicle would need to come to a complete hold, "]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field roadConfigurationConfidence: information about the source of the road configuration and the confidence in the information."]
    #[doc = " *"]
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field lightBarSirenInUse: optionally indicates whether a roadwork vehicle has switched on the light bar or siren. "]
    #[doc = " * It is used when the roadwork involves a specific roadwork vehicle"]
    #[doc = " *"]
    #[doc = " * @field closedLanes: optionally indicates whether the roadwork has caused the closure of one or several driving lanes. "]
    ...
    #[doc = " *"]
    #[doc = " * @field restriction: the optional type(s) of vehicles that are restricted to access the road work zone. "]
    #[doc = " * More than one vehicle types may be provided by this component if the restriction apply to multiple vehicle types. "]
    #[doc = " *"]
    #[doc = " * @field speedLimit: the optional speed limitation applied to the roadwork zone."]
    #[doc = " *"]
    ...
    #[doc = " *"]
    #[doc = " * @field recommendedPath: the optional recommended itinerary in order to contour the roadworks zone. If present, a recommended path "]
    ...
    #[doc = " *"]
    #[doc = " * @field startingPointSpeedLimit: the optional effective starting position of a speed limit being applied to the roadwork zone, "]
    ...
    #[doc = " *"]
    #[doc = " * @field trafficFlowRule: optionally indicates the side of the road to which the traffic should flow around a roadwork."]
    #[doc = " *"]
    #[doc = " * @field referenceDenms: an optional sequence of actionIds for different DENMs that describe the same event. "]
    ...
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    pub struct SituationContainerExtGroupEventEndFactor {
        #[rasn(identifier = "eventEndFactor")]
        pub event_end_factor: Option<MultiplicativeFactor>,
        #[rasn(identifier = "perceivedEvent")]
        pub perceived_event: Option<PerceivedEvent>,
    }
    impl SituationContainerExtGroupEventEndFactor {
        pub fn new(
            event_end_factor: Option<MultiplicativeFactor>,
            perceived_event: Option<PerceivedEvent>,
        ) -> Self {
            Self {
                event_end_factor,
                perceived_event,
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field informationQuality: the quality level of the information provided by the ITS-S application of the originating ITS-S. "]
    #[doc = " * It indicates the probability of the detected event being truly existent at the event position."]
    #[doc = " *"]
    #[doc = " * @field eventType: the event type, including direct cause and sub cause."]
    #[doc = " *"]
    #[doc = " * @field linkedCause: the optional type of a linked event co-existing at the same time and the same place (same event zone), "]
    #[doc = " * including direct cause and sub cause of the linked event, for which no other DENM is sent out."]
    #[doc = " *"]
    #[doc = " * @field eventZone: an optional list of EventPoint, using the position indicated in the component eventPosition of the Management container "]
    #[doc = " * as the reference position for the first EventPoint."]
    #[doc = " *"]
    #[doc = " * @field linkedDenms: the optional list of DF ActionId, pointing to DENMs that are semantically connected because applying to consecutive "]
    #[doc = " * event zones at the same time."]
    #[doc = " *"]
    #[doc = " * @field eventEnd: the end position of the event along the road that is affected by the event w.r.t. the component eventPosition of the "]
    #[doc = " * Management container. This end position is represented by the length of the event along the road. "]
    #[doc = " *"]
    #[doc = " * @field eventEndFactor: an optional component that applies to the component eventEnd. It is a factor to be multiplied with the value given in eventEnd."]
    #[doc = " *"]
    #[doc = " * @field perceivedEvent: an optional component that, in case of vehicle ITS-S, indicates the nature of the information about the event."]
    #[doc = " *"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    pub struct SituationContainer {
        ...
        #[rasn(extension_addition_group, identifier = "SEQUENCE")]
        pub ext_group_event_end_factor: Option<SituationContainerExtGroupEventEndFactor>,
    }
    impl SituationContainer {
        pub fn new(
            ...
            ext_group_event_end_factor: Option<SituationContainerExtGroupEventEndFactor>,
        ) -> Self {
            Self {
                information_quality,
                event_type,
    ...
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
    #[doc = " * @field stationarySince: the optional time duration of the stationary vehicle being stationary."]
    #[doc = " *"]
    #[doc = " * @field stationaryCause: optional additional information to describe causes of the stationary vehicle event such as human problem."]
    #[doc = " *"]
    #[doc = " * @field carryingDangerousGoods: optional information on the type of dangerous goods, the required emergency action and other information."]
    #[doc = " *"]
    #[doc = " * @field numberOfOccupants: the optional estimated number of occupants involved in the stationary vehicle event."]
    #[doc = " *"]
    #[doc = " * @field vehicleIdentification: the optional identification of the stationary vehicle."]
    #[doc = " *"]
