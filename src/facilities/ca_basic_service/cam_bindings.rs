...
pub mod cam_pdu_descriptions {
    extern crate alloc;
    use super::etsi_its_cdd::{
        AccelerationComponent, AccelerationControl, BasicContainer, BasicLaneConfiguration,
        BrakeControl, CartesianAngle, CauseCodeV2, CenDsrcTollingZone, ClosedLanes,
        ConfidenceLevels, Curvature, CurvatureCalculationMode, DangerousGoodsBasic, DriveDirection,
        EmbarkationStatus, EmergencyPriority, ExteriorLights, GeneralizedLanePositions,
        GenerationDeltaTime, Heading, ItsPduHeader, LanePosition, LightBarSirenInUse,
        MetaInformation, Path, PathPredictedList, PerformanceClass, PolygonalLine,
        ProtectedCommunicationZonesRSU, PtActivation, ReferencePosition, RoadworksSubCauseCode,
        SpecialTransportType, Speed, SpeedLimit, StabilityChangeIndication, StationType,
        SteeringWheelAngle, TrafficRule, VehicleHeight2, VehicleLength, VehicleMovementControl,
        VehicleRole, VehicleWidth, VruMovementControl, VruSubProfileBicyclist, Wgs84Angle,
        WiperStatus, YawRate,
    };
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Basic Vehicle Container High Frequency."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field heading: It represent the heading and heading accuracy of the vehicle movement of the originating ITS-S with regards to the true north. "]
    #[doc = "* The heading accuracy provided in the heading Confidence value shall provide the accuracy of the measured vehicle heading with a confidence level "]
    #[doc = "* of 95 %. Otherwise, the value of the headingConfidence shall be set to unavailable."]
    #[doc = "*"]
    #[doc = "* @field speed: It represent driving speed and speed accuracy of the originating ITS-S. The speed accuracy provided in the speedConfidence shall "]
    #[doc = "* provide the accuracy of the speed value with a confidence level of 95 %. Otherwise, the speedConfidence shall be set to unavailable."]
    #[doc = "*"]
    #[doc = "* @field driveDirection: This component represent the vehicle drive direction (forward or backward) of the originating ITS-S."]
    #[doc = "*"]
    #[doc = "* @field vehicleLength: This component represent the vehicle length value and vehicle length confidence indication of the vehicle ITS-S that "]
    #[doc = "* originate the CAM. "]
    #[doc = "*"]
    #[doc = "* @field vehicleWidth: This component represents the Vehicle Width of the vehicle ITS-S that originates the CAM excluding side mirrors and possible"]
    #[doc = "* similar extensions."]
    #[doc = "*"]
    #[doc = "* @field longitudinalAcceleration: It represent the vehicle Longitudinal Acceleration of the originating ITS-S in the centre of the mass of the "]
    #[doc = "* empty vehicle. It shall include the measured vehicle longitudinal acceleration and its accuracy value with the confidence level of 95 %. "]
    #[doc = "* Otherwise, the longitudinalAccelerationConfidence shall be set to unavailable. "]
    #[doc = "*"]
    #[doc = "* @field curvature: this component reppresent the actual trajectory of the vehicle. "]
    #[doc = "*"]
    #[doc = "* @field curvatureCalculationMode: It indicates whether vehicle yaw-rate is used in the calculation of the curvature of the vehicle ITS-S that"]
    #[doc = "* originates the CAM."]
    #[doc = "*"]
    #[doc = "* @field yawRate: It denotes the vehicle rotation around the centre of mass of the empty vehicle. The leading sign denotes the direction of "]
    #[doc = "* rotation. The value is negative if the motion is clockwise when viewing from the top."]
    #[doc = "* yawRateConfidence denotes the accuracy for the 95 % confidence level for the measured yawRateValue. Otherwise, the value of yawRateConfidence"]
    #[doc = "* shall be set to unavailable."]
    #[doc = "*"]
    #[doc = "* @field accelerationControl: an optional component which represents the current status of the vehcile mechnanisms controlling the longitudinal movement of the vehcile ITS-S"]
    #[doc = "* (e.g. brake pedal,  gas pedal, etc. engaged) that originate the CAM."]
    #[doc = "*"]
    #[doc = "* @field lanePosition: an optional component which represents the lanePosition of the referencePosition of a vehicle. This component shall be present if the data is "]
    #[doc = "* available at the originating ITS-S."]
    #[doc = "*"]
    #[doc = "* @field steeringWheelAngle: an optional component which indicates the steering wheel angle and accuracy as measured at the vehicle ITS-S that originates the CAM."]
    #[doc = "*"]
    #[doc = "* @field lateralAcceleration: an optional component which represents the vehicle lateral acceleration of the originating ITS-S in the centre of the mass of the empty vehicle. "]
    #[doc = "* It shall include the measured vehicle lateral acceleration and its accuracy value with the confidence level of 95%."]
    #[doc = "*"]
    #[doc = "* @field verticalAcceleration: an optional component which indicates the originating ITS-S in the centre of the mass of the empty vehicle."]
    #[doc = "* "]
    #[doc = "* @field performanceClass: an optional component characterizes the maximum age of the CAM data elements with regard to the generation delta time."]
    #[doc = "*"]
    #[doc = "* @field cenDsrcTollingZone: an optional component which represents the information about the position of a CEN DSRC Tolling Station operating in the 5,8 GHz frequency band."]
    #[doc = ""]
    ...
    pub struct BasicVehicleContainerHighFrequency {
        ...
        pub longitudinal_acceleration: AccelerationComponent,
        ...
        pub lateral_acceleration: Option<AccelerationComponent>,
        #[rasn(identifier = "verticalAcceleration")]
        pub vertical_acceleration: Option<AccelerationComponent>,
    ...
    impl BasicVehicleContainerHighFrequency {
        pub fn new(
            ...
            lateral_acceleration: Option<AccelerationComponent>,
            vertical_acceleration: Option<AccelerationComponent>,
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Basic Vehicle Container Low Frequency."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field vehicleRole: represent the role of the vehicle ITS-S that originates the CAM. Only values 0 to 7 shall be used."]
    #[doc = "*"]
    #[doc = "* @field exteriorLights: represent the status of the most important exterior lights switches of the vehicle ITS-S that originates the CAM."]
    #[doc = "*"]
    #[doc = "* @field pathHistory: which represents the vehicle's recent movement over some past time and/or distance. It consists of a list of path points,"]
    #[doc = "* each represented as DF PathPoint. The list of path points may consist of up to 23 elements. "]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "* "]
    #[doc = "* This type represents the CAM PDU."]
    #[doc = "*"]
    #[doc = "* It shall include the following componenets:"]
    #[doc = "*"]
    #[doc = "* @field header: the header of the CAM PDU."]
    #[doc = "*"]
    #[doc = "* @field cam: the payload of the CAM PDU."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    pub struct CAM {
    ...
    impl CAM {
        pub fn new(header: ItsPduHeader, cam: CamPayload) -> Self {
            Self { header, cam }
        }
    }
    #[doc = "*"]
    #[doc = "* @field basicContainer: the mandatory basic container of the CAM."]
    #[doc = "*"]
    #[doc = "* @field highFrequencyContainer: the mandatory container represents the high frequency of the CAM."]
    #[doc = "* "]
    #[doc = "* @field lowFrequencyContainer: the optional conatainer represents the low frequency of the CAM."]
    #[doc = "*"]
    #[doc = "* @field specialVehicleContainer: The special container of the CAM shall be present as defined in clause 6.1.2. "]
    #[doc = "* The content of the container shall be set according to the value of the vehicleRole component as specified in Table 5. "]
    #[doc = "*"]
    #[doc = "* @field extensionContainers: the list of CAM extension containers, including its container type identifier and the container itself."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct CamParameters {
        ...
        #[rasn(extension_addition, identifier = "extensionContainers")]
        pub extension_containers: Option<WrappedExtensionContainers>,
    }
    impl CamParameters {
        pub fn new(
            ...
            extension_containers: Option<WrappedExtensionContainers>,
        ) -> Self {
            Self {
                basic_container,
    ...
    #[doc = "*"]
    #[doc = "* This type represents the CAM payload. "]
    #[doc = "*"]
    #[doc = "* It shall include the following components: "]
    #[doc = "*"]
    #[doc = "* @field generationDeltaTime: Time corresponding to the time of the reference position in the CAM, considered as time of the CAM generation."]
    #[doc = "*"]
    #[doc = "* @field camParameters: The sequence of CAM mandatory and optional container."]
    #[doc = "*"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    pub struct CamPayload {
    ...
    #[doc = "*"]
    #[doc = "* This type contains type-specific information about cyclists."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field vruSubProfileBicyclist: it indicates the detailed type of the cyclist."]
    #[doc = "*"]
    #[doc = "* @field vruMovementControl: it includes information about the movement control of the bicycle."]
    #[doc = "*"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct CyclistTypeSpecificInformation {
        #[rasn(value("0..=10"), identifier = "vruSubProfileBicyclist")]
        pub vru_sub_profile_bicyclist: Option<VruSubProfileBicyclist>,
        #[rasn(identifier = "vruMovementControl")]
        pub vru_movement_control: Option<VruMovementControl>,
    }
    impl CyclistTypeSpecificInformation {
        pub fn new(
            vru_sub_profile_bicyclist: Option<VruSubProfileBicyclist>,
            vru_movement_control: Option<VruMovementControl>,
        ) -> Self {
            Self {
                vru_sub_profile_bicyclist,
                vru_movement_control,
            }
        }
    }
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Dangerous Goods Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field dangerousGoodsBasic: identifies the type of the dangerous goods transported by the vehicle that originates the CAM. It shall be present if"]
    #[doc = "* the data is available in the originating ITS S."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "*"]
    #[doc = "* This type contains contextual, map-based location information."]
    #[doc = "* eHorizon is defined as a tool to convey the part of the road network and its characteristics derived from map data located in front of and behind the vehicle along the road."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field segmentAhead: the road segment that the vehicle is predicted to reach, starting from the reference position."]
    #[doc = "* At least one node must be filled in so that the current map position can be calculated on the receiver side."]
    #[doc = "*"]
    #[doc = "* @field nodeProbabilities: confidence values for each node in segmentAhead, indicating how confident we are that the ITS station will reach that point."]
    #[doc = "*"]
    #[doc = "* @field segmentBehind: the road segment that the vehicle has passed, based on the collected data, starting from the reference position."]
    #[doc = "* At least one node must be filled in so that the current map position can be calculated on the receiver side."]
    #[doc = "*"]
    #[doc = "* @field laneLevelDetails: provides information about the configuration of the road at the position indicated by the component referencePosition of the Basic Container and for a given reference direction."]
    #[doc = "*"]
    #[doc = "* @field segmentSource: it represents the origin of the map-specific data."]
    #[doc = "*"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct EHorizonLocationSharingContainer {
        #[rasn(identifier = "segmentAhead")]
        pub segment_ahead: PolygonalLine,
        #[rasn(identifier = "nodeProbabilities")]
        pub node_probabilities: Option<ConfidenceLevels>,
        #[rasn(identifier = "segmentBehind")]
        pub segment_behind: PolygonalLine,
        #[rasn(identifier = "laneLevelDetails")]
        pub lane_level_details: Option<BasicLaneConfiguration>,
        #[rasn(value("0.."), identifier = "segmentSource")]
        pub segment_source: Option<MetaInformation>,
    }
    impl EHorizonLocationSharingContainer {
        pub fn new(
            segment_ahead: PolygonalLine,
            node_probabilities: Option<ConfidenceLevels>,
            segment_behind: PolygonalLine,
            lane_level_details: Option<BasicLaneConfiguration>,
            segment_source: Option<MetaInformation>,
        ) -> Self {
            Self {
                segment_ahead,
                node_probabilities,
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Emergency Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field lightBarSirenInUse: it indicates whether light-bar or a siren is in use by the vehicle originating the CAM."]
    #[doc = "*"]
    #[doc = "* @field incidentIndication: the optional incident related to the roadworks to provide additional information of the roadworks zone."]
    #[doc = "*"]
    #[doc = "* @field emergencyPriority: the optional component represent right of way indicator of the vehicle ITS-S that originates the CAM PDU."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    pub struct ExtensionContainerId(pub Integer);
    #[doc = "*"]
    #[doc = "* This type represents the generalized lane positions container."]
    #[doc = "*"]
    #[doc = "* Contains detailed information about the transversal position of the ITS station with respect to the road and potentially about the lane type."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct GeneralizedLanePositionsContainer {
        #[rasn(identifier = "generalizedLanePositions")]
        pub generalized_lane_positions: GeneralizedLanePositions,
    }
    impl GeneralizedLanePositionsContainer {
        pub fn new(generalized_lane_positions: GeneralizedLanePositions) -> Self {
            Self {
                generalized_lane_positions,
            }
        }
    }
    #[doc = "*"]
    #[doc = "* This type represents the high frequency container."]
    #[doc = "* "]
    #[doc = "* It shall include the following components: "]
    #[doc = "*"]
    #[doc = "* @field basicVehicleContainerHighFrequency: The mandatory high frequency container of the CAM when the originating ITS-S is of the type vehicle ITS-S."]
    #[doc = "*"]
    #[doc = "* @field rsuContainerHighFrequency: The mandatory high frequency container of CAM when the type of the originating ITS-S is RSU ITS-S."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    ...
    #[doc = "*"]
    #[doc = "* This type represents the low frequency container."]
    #[doc = "* "]
    #[doc = "* It shall include the following components: "]
    #[doc = "*"]
    #[doc = "* The low frequency container of the CAM when the originating ITS-S is of the type vehicle ITS-S. It shall be present as defined in clause 6.1.2."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(choice, automatic_tags)]
    #[non_exhaustive]
    ...
    #[doc = "*"]
    #[doc = "* This type represents the path prediction container."]
    #[doc = "*"]
    #[doc = "* Contains information about the possible future paths of ITS station."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct PathPredictionContainer {
        #[rasn(identifier = "pathPredictedList")]
        pub path_predicted_list: PathPredictedList,
    }
    impl PathPredictionContainer {
        pub fn new(path_predicted_list: PathPredictedList) -> Self {
            Self {
                path_predicted_list,
            }
        }
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Public Transport Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field embarkationStatus: It indicates whether the passenger embarkation is currently ongoing. "]
    #[doc = "*"]
    #[doc = "* @field ptActivation: an optional component used for controlling traffic lights, barriers, bollards, etc."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the RSU Container High Frequency."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field protectedCommunicationZonesRSU: an optional Information about position of a CEN DSRC Tolling Station operating in the 5,8 GHz frequency "]
    #[doc = "* band. If this information is provided by RSUs a receiving vehicle ITS-S is prepared to adopt mitigation techniques when being in the vicinity of"]
    #[doc = "* CEN DSRC tolling stations. "]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Rescue Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field lightBarSirenInUse: it indicates whether light-bar or a siren is in use by the vehicle originating the CAM."]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Road Works Container Basic."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field roadworksSubCauseCode: The optional component, in case the originating ITS-S is mounted to a vehicle ITS-S participating to roadwork. It "]
    #[doc = "* provides information on the type of roadwork that it is currently undertaking. This component shall be present if the data is available in "]
    #[doc = "* originating ITS S."]
    #[doc = "*"]
    #[doc = "* @field lightBarSirenInUse: it indicates whether light-bar or a siren is in use by the vehicle originating the CAM."]
    #[doc = "*"]
    #[doc = "* @field closedLanes: an optional component which provides information about the opening/closure status of the lanes ahead. Lanes are counted from"]
    #[doc = "* the inside boarder of the road. If a lane is closed to traffic, the corresponding bit shall be set to 1."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Safety Car Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field lightBarSirenInUse: it indicates whether light-bar or a siren is in use by the vehicle originating the CAM."]
    ...
    #[doc = "* @field incidentIndication: the optional incident related to the roadworks to provide additional information of the roadworks zone."]
    #[doc = "*"]
    #[doc = "* @field trafficRule: an optional rule indicates whether vehicles are allowed to overtake a safety car that is originating this CAM."]
    #[doc = "*"]
    #[doc = "* @field speedLimit: an optional speed indicates whether a speed limit is applied to vehicles following the safety car. "]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detaild information of the Special Transport Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field specialTransportType: which indicates whether the originating ITS-S is mounted on a special transport vehicle with heavy or oversized load"]
    #[doc = "* or both. It shall be present if the data is available in originating ITS-S."]
    #[doc = "*"]
    #[doc = "* @field lightBarSirenInUse: indicates whether light-bar or a siren is in use by the vehicle originating the CAM."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    #[doc = "*"]
    #[doc = "* This type represent the Special Vehicle Container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field publicTransportContainer: If the vehicleRole component is set to publicTransport(1) this container shall be present."]
    #[doc = "*"]
    #[doc = "* @field specialTransportContainer: If the vehicleRole component is set to specialTransport(2) this container shall be present."]
    #[doc = "*"]
    #[doc = "* @field dangerousGoodsContainer: If the vehicleRole component is set to dangerousGoods(3) this container shall be present."]
    #[doc = "*"]
    #[doc = "* @field roadWorksContainerBasic: If the vehicleRole component is set to roadWork(4) this container shall be present. "]
    #[doc = "*"]
    #[doc = "* @field rescueContainer: If the vehicleRole component is set to rescue(5) this container shall be present. "]
    #[doc = "*"]
    #[doc = "* @field emergencyContainer: If the vehicleRole component is set to emergency(6) this container shall be present."]
    #[doc = "*"]
    #[doc = "* @field safetyCarContainer: If the vehicleRole component is set to safetyCar(7) this container shall be present. "]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(choice, automatic_tags)]
    #[non_exhaustive]
    ...
    #[doc = "*"]
    #[doc = "* This type contains detailed information about two wheelers. It is meant to use for StationType"]
    #[doc = "* cyclist, moped and motorcycle."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field typeSpecificInformation: this data field contains type specific information about two wheelers."]
    #[doc = "*"]
    #[doc = "* @field rollAngle: this data field describes the roll angle of the two wheeler."]
    #[doc = "*"]
    #[doc = "* @field orientation: this data field describes the orientation of the two wheeler."]
    #[doc = "*"]
    #[doc = "* @field stabilityChangeIndication: this data field describes if the two wheeler is about to lose control."]
    #[doc = "*"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct TwoWheelerContainer {
        #[rasn(identifier = "typeSpecificInformation")]
        pub type_specific_information: Option<TwoWheelerTypeSpecificInformation>,
    ...
    impl TwoWheelerContainer {
        pub fn new(
            type_specific_information: Option<TwoWheelerTypeSpecificInformation>,
    ...
    #[doc = "*"]
    #[doc = "* This type contains type specific information about a two wheeler."]
    #[doc = "*"]
    #[doc = "* It includes one of the following components:"]
    #[doc = "*"]
    #[doc = "* @field cyclist: it contains cyclist-specific information."]
    #[doc = "*"]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(choice, automatic_tags)]
    #[non_exhaustive]
    pub enum TwoWheelerTypeSpecificInformation {
        cyclist(CyclistTypeSpecificInformation),
    }
    #[doc = "*"]
    #[doc = "* This type represents the vehicle movement control container."]
    #[doc = "*"]
    #[doc = "* Contains information about the current vehicle movement control status "]
    #[doc = "* of ITS station."]
    #[doc = "*  This contains: "]
    #[doc = "*\t- brake and acceleration pedal position status information"]
    #[doc = "* \t- mechanism for lateral, longitudinal movements dimensions "]
    #[doc = "*\t  of the vehicle "]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct VehicleMovementControlContainer {
        #[rasn(identifier = "vehicleMovementControl")]
        pub vehicle_movement_control: VehicleMovementControl,
    }
    impl VehicleMovementControlContainer {
        pub fn new(vehicle_movement_control: VehicleMovementControl) -> Self {
            Self {
                vehicle_movement_control,
            }
        }
    }
    #[doc = "*"]
    #[doc = "* This type represents the very low frequency container."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    #[doc = "* @field vehicleHeight: this component represents the height of the vehicle that originates the CAM."]
    #[doc = "*"]
    #[doc = "* @field wiperStatus: this component represents the status of the wipers of the vehicle that originates the CAM, at the time indicated by generationDeltaTime."]
    #[doc = "*"]
    #[doc = "* @field brakeControl: this component represents the status of the brake control system of the vehicle that originates the CAM, "]
    #[doc = "* at the time indicated by generationDeltaTime and during the period 10 seconds before that time."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    #[non_exhaustive]
    pub struct VeryLowFrequencyContainer {
        #[rasn(identifier = "vehicleHeight")]
        pub vehicle_height: Option<VehicleHeight2>,
        #[rasn(identifier = "wiperStatus")]
        pub wiper_status: Option<WiperStatus>,
        #[rasn(identifier = "brakeControl")]
        pub brake_control: Option<BrakeControl>,
    }
    impl VeryLowFrequencyContainer {
        pub fn new(
            vehicle_height: Option<VehicleHeight2>,
            wiper_status: Option<WiperStatus>,
            brake_control: Option<BrakeControl>,
        ) -> Self {
            Self {
                vehicle_height,
                wiper_status,
    ...
    #[doc = "*"]
    #[doc = "* This DF represents a CAM container preceded by its type identifier and a length indicator."]
    #[doc = "*"]
    #[doc = "* It shall include the following components:"]
    #[doc = "*"]
    ...
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    pub struct WrappedExtensionContainer {
        #[rasn(identifier = "containerId")]
        pub container_id: ExtensionContainerId,
        #[rasn(identifier = "containerData")]
        pub container_data: Any,
    }
    impl WrappedExtensionContainer {
        pub fn new(container_id: ExtensionContainerId, container_data: Any) -> Self {
            Self {
                container_id,
                container_data,
            }
    ...
    #[doc = "*"]
    #[doc = "* This DF represents a list of CAM containers, each with their type identifier."]
    #[doc = ""]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(delegate, size("1..=8", extensible))]
    pub struct WrappedExtensionContainers(pub SequenceOf<WrappedExtensionContainer>);
    pub static E_HORIZON_LOCATION_SHARING_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(2i128)));
    pub static GENERALIZED_LANE_POSITIONS_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(5i128)));
    pub static PATH_PREDICTION_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(4i128)));
    #[doc = "*"]
    #[doc = "* These value assignments represent specific values of the container type identifier. "]
    #[doc = ""]
    pub static TWO_WHEELER_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(1i128)));
    pub static VEHICLE_MOVEMENT_CONTROL_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(6i128)));
    pub static VERY_LOW_FREQUENCY_CONTAINER: LazyLock<ExtensionContainerId> =
        LazyLock::new(|| ExtensionContainerId(Integer::from(3i128)));
}
#[allow(
    non_camel_case_types,
    non_snake_case,
...
pub mod etsi_its_cdd {
    ...
    #[doc = "*"]
    #[doc = " * This DE indicates the status of the vehicle´s brake control system during an externally defined period of time. "]
    #[doc = " *"]
    #[doc = " * The corresponding bit shall be set to 1 under the following conditions:"]
    ...
    #[doc = " * Note: connections are  allowed ï¿½maneuversï¿½ (e.g. an ingress / egress relation) on an intersection."]
    #[doc = " *"]
    #[doc = " * @category: Road topology information"]
    #[doc = " * @revision: Created in V2.2.1"]
    #[doc = ""]
    ...
    #[doc = " * If this component is absent, the ending position is implicitly defined by other means, e.g. the starting point of the next RoadConfigurationSection, or the sectionï¿½s length."]
    #[doc = " *"]
    #[doc = " * @field connectedPaths: the identifier(s) of the path(s) having one or an ordered subset of waypoints located upstream of the RoadConfigurationSectionï¿½ starting point. "]
    #[doc = " * "]
    ...
    #[doc = " * "]
    #[doc = " * @field isEventZoneConnected: indicates, if set to TRUE, that the @ref EventZone incl. its reference position has one or an ordered subset of waypoints located upstream of the RoadConfigurationSectionï¿½ starting point."]
    #[doc = " *"]
    #[doc = " * @category: Road topology information"]
    #[doc = " * @revision: Created in V2.2.1"]
    #[doc = ""]
    ...
    #[doc = "*"]
    #[doc = " * This DF provides information about the status of the vehicle´s movement control mechanisms. "]
    #[doc = " *"]
    #[doc = " * It shall include the following components: "]
    #[doc = " *"]
