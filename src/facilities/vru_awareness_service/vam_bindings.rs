...
pub mod etsi_its_cdd {
    ...
    #[doc = " * - `1` for performance class A as defined in ETSI TS 101 539-1 [5],"]
    #[doc = " * - `2` for performance class B as defined in ETSI TS 101 539-1 [5],"]
    ...
    #[doc = " * - 3 `moped`            - ITS-S mounted on light motor vehicles with less than four wheels as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] "]
    #[doc = "                            class L1, L2 (VRU Profile 3),"]
    #[doc = " * - 4 `motorcycles`      - ITS-S mounted on motor vehicles with less than four wheels as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] "]
    #[doc = "                            class L3, L4, L5, L6, L7 (VRU Profile 3),"]
    #[doc = " * - 5 `passengerCar`     - ITS-S mounted on small passenger vehicles as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] class M1,"]
    #[doc = " * - 6 `bus`              - ITS-S mounted on large passenger vehicles as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] class M2, M3,"]
    #[doc = " * - 7 `lightTruck`       - ITS-S mounted on light Goods Vehicles as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] class N1,"]
    #[doc = " * - 8 `heavyTruck`       - ITS-S mounted on Heavy Goods Vehicles as defined in UNECE/TRANS/WP.29/78/Rev.4 [16] class N2 and N3,"]
    #[doc = " * - 9 `trailer`          - ITS-S mounted on an unpowered vehicle that is intended to be towed by a powered vehicle as defined in "]
    #[doc = "                            UNECE/TRANS/WP.29/78/Rev.4 [16] class O,"]
    ...
    #[doc = " * "]
    #[doc = " * @note: this DE is kept for backwards compatibility reasons only. It is recommended to use the @ref TrafficParticipantType instead."]
    #[doc = " * @category: Communication information."]
...
pub mod vam_pdu_descriptions {
    ...
    use std::sync::LazyLock;
    #[doc = "*"]
    #[doc = " * @details ItsPduHeaderVam"]
    #[doc = " * The ITS PDU header for the VAM."]
    #[doc = " *"]
    #[doc = " * This DF includes DEs for the VAM _protocolVersion_, the VAM message type identifier _messageID_ "]
    #[doc = " * and the station identifier _stationID_ of the originating ITS-S."]
    #[doc = " *"]
    #[doc = " * @category: Communication information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(delegate)]
    pub struct ItsPduHeaderVam(pub ItsPduHeader);
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    pub struct VAM {
        pub header: ItsPduHeaderVam,
        pub vam: VruAwareness,
    }
    impl VAM {
        pub fn new(header: ItsPduHeaderVam, vam: VruAwareness) -> Self {
            Self { header, vam }
        }
    }
    #[doc = "*"]
    #[doc = " * @details VamParameters"]
    #[doc = " * The VAM payload includes the @ref BasicContainer and @ref VruHighFrequencyContainer. "]
    #[doc = " * The VAM payload may also include additional containers: @ref VruLowFrequencyContainer,"]
    #[doc = " * @ref VruClusterInformationContainer, @ref VruClusterOperationContainer and @ref VruMotionPredictionContainer."]
    #[doc = " * The selection of the additional containers depends on the dissemination criteria, "]
    #[doc = " * e.g. _vruCluster_ or _MotionDynamicPrediction_ availability."]
    #[doc = " * "]
    #[doc = " * @category: Communication information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = "*"]
    ...
    #[doc = "*"]
    #[doc = " * @details VruAwareness"]
    #[doc = " * VAM payload."]
    #[doc = " *"]
    #[doc = " * It includes the time stamp of the VAM and the VAM different containers"]
    #[doc = " *"]
    #[doc = " * @category: Communication information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    ...
    #[doc = "*"]
    #[doc = " * @details VruClusterInformationContainer"]
    #[doc = " * The VRU Cluster Information container of the VAM provides the information/parameters relevant to the VRU cluster."]
    #[doc = " * It is mandatory if the VAM is transmitted by VRU cluster leader."]
    #[doc = " * It includes the following components (setting indications are specified in clause 7.3.5 of TS 103 300-3): "]
    #[doc = " *"]
    #[doc = " * @field vruClusterInformation: set of parammeters releated to the VRU cluster. "]
    #[doc = " *        When transmitted by a VRU ITS-S, the clusterId and clusterBoundingBoxShape fields inside this DF shall be present."]
    #[doc = " *        The clusterBoundingBoxShape is positioned with respect to the position sent in the BasicContainer."]
    #[doc = " * "]
    #[doc = " * @category: VRU information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    ...
    pub struct VruClusterInformationContainer {
        #[rasn(value("0.."), identifier = "vruClusterInformation")]
        pub vru_cluster_information: VruClusterInformation,
    }
    impl VruClusterInformationContainer {
        pub fn new(vru_cluster_information: VruClusterInformation) -> Self {
            Self {
                vru_cluster_information,
            }
        }
    }
    #[doc = "*"]
    #[doc = " * @details VruClusterOperationContainer"]
    #[doc = " * The VRU Cluster Operation container of the VAM provides information relevant to change of cluster state and composition."]
    #[doc = " * It is mandatory if the VAM is transmitted by a VRU joining, leaving or breaking up a cluster."]
    #[doc = " * It includes the following components (setting indications are specified in clause 7.3.5 of TS 103 300-3). "]
    #[doc = " * At least one of the fields below shall be present if the container is present in the VAM: "]
    #[doc = " *"]
    #[doc = " * @field clusterJoinInfo: indicates the intent of an individual VAM transmitter to join a cluster. "]
    #[doc = " * @field clusterLeaveInfo : indicates that an individual VAM transmitter has recently left the VRU cluster. "]
    #[doc = " * @field clusterBreakupInfo: indicates the intent of a cluster VAM transmitter to stop sending cluster VAMs. "]
    #[doc = " * @field clusterIdChangeTimeInfo: indicates the intent of a cluster VAM transmitter to change cluster ID. "]
    #[doc = " * "]
    #[doc = " * @category: VRU information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    ...
    pub struct VruClusterOperationContainer {
        ...
        #[rasn(identifier = "clusterIdChangeTimeInfo")]
        pub cluster_id_change_time_info: Option<DeltaTimeQuarterSecond>,
    }
    impl VruClusterOperationContainer {
        pub fn new(
            ...
            cluster_id_change_time_info: Option<DeltaTimeQuarterSecond>,
        ) -> Self {
            Self {
                cluster_join_info,
                cluster_leave_info,
                cluster_breakup_info,
                cluster_id_change_time_info,
            }
        }
    }
    #[doc = "*"]
    #[doc = " * @details VruHighFrequencyContainer"]
    #[doc = " * The VRU HF container of the VAM contains potentially fast-changing status information of the VRU ITS-S."]
    #[doc = " * It includes the following components (setting indications are specified in clause 7.3.3 of TS 103 300-3): "]
    #[doc = " * "]
    #[doc = " * @field heading: heading and heading confidence of the originating VRU with regards to the true north. "]
    #[doc = " * @field speed: speed in moving direction and speed confidence of the originating VRU.   "]
    #[doc = " * @field longitudinalAcceleration: longitudinal acceleration of the originating VRU. "]
    #[doc = " * @field curvature: related to the actual trajectory of the originating VRU vehicle."]
    #[doc = "          _(recommended for VRU Profile 2)_"]
    #[doc = " * @field curvatureCalculationMode: indicates whether vehicle yaw-rate is used in the calculation of"]
    #[doc = " *        the curvature of the VRU vehicle ITS-S that originates the VAM. _(recommended for VRU Profile 2)_"]
    #[doc = " * @field yawRate: yaw rate of originating VRU vehicle. _(recommended for VRU Profile 2)_"]
    #[doc = " * @field lateralAcceleration: originating VRU lateral acceleration in the street plane."]
    #[doc = " *        This field shall be present if the data is available at the originating ITS-S. _(recommended for VRU Profile 2)_ "]
    #[doc = " * @field verticalAcceleration: vertical acceleration of the originating VRU."]
    #[doc = " *        This field shall be present if the data is available at the originating ITS-S."]
    #[doc = " * @field vruLanePosition: lane position of the referencePosition of a VRU, which is either a VRU-specific non-traffic lane  "]
    #[doc = " *        or a standard traffic lane. This field shall be present if the data is available at the originating ITS-S."]
    #[doc = " * @field environment: provides contextual awareness of the VRU among other road users."]
    #[doc = " *        This field shall be present only if the data is available at the originating ITS-S."]
    #[doc = " * @field movementControl: indicates the mechanism used by the VRU to control the  longitudinal movement of the VRU vehicle."]
    #[doc = " *        This field shall be present only if the data is available at the originating ITS-S. _(recommended for VRU Profile 2)_"]
    #[doc = " * @field orientation : complements the dimensions of the VRU vehicle by defining the angle of the VRU vehicle longitudinal"]
    #[doc = " *        axis with regards to the WGS84 north. _(recommended for VRU Profile 2)_"]
    #[doc = " * @field rollAngle: provides the angle and angle accuracy between the ground plane and the current orientation of a vehicle's"]
    #[doc = " *        y-axis with respect to the ground plane about the x-axis according to the ISO 8855. "]
    #[doc = " *        This field shall be present only if the data is available at the originating ITS-S. _(recommended for VRU Profile 2)_"]
    #[doc = " * @field deviceUsage: provides indications from the personal device about the potential "]
    #[doc = " *        activity of the VRU. This field shall be present only if the data is available at the originating ITS-S."]
    #[doc = " *        _(recommended for VRU Profile 1)_"]
    #[doc = " * "]
    #[doc = " * @category: VRU information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    ...
    pub struct VruHighFrequencyContainer {
        ...
        pub vru_lane_position: Option<GeneralizedLanePosition>,
    ...
    impl VruHighFrequencyContainer {
        pub fn new(
            ...
            vru_lane_position: Option<GeneralizedLanePosition>,
    ...
    #[doc = "*"]
    #[doc = " * @details VruLowFrequencyContainer"]
    #[doc = " * The VRU LF container of the VAM contains potentially slow-changing information of the VRU ITS-S."]
    #[doc = " * It is mandatory with higher periodicity as specified in clause 6.2 or when VRU cluster operation container is present."]
    #[doc = " * It includes the following components (setting indications are specified in clause 7.3.4 of TS 103 300-3): "]
    #[doc = " *"]
    #[doc = " * @field profileAndSubprofile: profile of the ITS-S that originates the VAM, including sub-profile information. "]
    #[doc = " * @field sizeClass: information about the size of the VRU. "]
    #[doc = " * @field exteriorLights: status of the most important exterior lights switches of the VRU ITS-S that originates the VAM. "]
    #[doc = " *        _(conditional mandatory as specified in clause 7.3.4 of TS 103 300-3)_ "]
    #[doc = " * "]
    #[doc = " * @category: VRU information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    ...
    pub struct VruLowFrequencyContainer {
        ...
        pub profile_and_subprofile: VruProfileAndSubprofile,
    ...
    impl VruLowFrequencyContainer {
        pub fn new(
            profile_and_subprofile: VruProfileAndSubprofile,
    ...
    #[doc = "*"]
    #[doc = " * @details VruMotionPredictionContainer"]
    #[doc = " * The VRU Motion Prediction container of the VAM carries the past and future motion state information of the VRU."]
    #[doc = " * It includes the following components (setting indications are specified in clause 7.3.6 of TS 103 300-3). "]
    #[doc = " * At least one of the fields below shall be present if the container is present in the VAM: "]
    #[doc = " *"]
    #[doc = " * @field pathHistory: represents the VRU's recent movement over some past time and/or distance. "]
    #[doc = " *        It consists of a list of path points. "]
    #[doc = " * @field pathPrediction: provides the set of predicted locations of the ITS-S, confidence values "]
    #[doc = " *        and the corresponding future time instants. "]
    #[doc = " * @field safeDistance: provides indication of safe distance between an ego-VRU and up to 8 other ITS-S "]
    #[doc = " *        or entity on the road to indicate whether the ego-VRU is at a safe distance (that is less likely to "]
    #[doc = " *        physically collide) from another ITS-S or entity on the road. "]
    #[doc = " * @field trajectoryInterceptionIndication: provides the indication for possible trajectory interception "]
    #[doc = " *        with up to 8 VRUs or other objects on the road.. "]
    #[doc = " * @field accelerationChangeIndication: provides an acceleration change indication of the VRU. "]
    #[doc = " *        When present this DF indicates an anticipated change in the VRU speed for period of actionDeltaTime."]
    #[doc = " * @field headingChangeIndication: provides additional data elements associated to heading change indicators "]
    #[doc = " *        such as a change of travel direction (left or right). "]
    #[doc = " *        The direction change action is performed for a period of actionDeltaTime. "]
    #[doc = " * @field stabilityChangeIndication: provides an estimation of the VRU stability. "]
    #[doc = " * "]
    #[doc = " * @category: GeoReference information, VRU information"]
    #[doc = " * @revision: V2.2.1"]
    #[doc = " "]
    #[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
    #[rasn(automatic_tags)]
    ...
    pub struct VruMotionPredictionContainer {
        ...
        pub path_prediction: Option<PathPredicted>,
        #[rasn(identifier = "safeDistance")]
        pub safe_distance: Option<SequenceOfSafeDistanceIndication>,
        #[rasn(identifier = "trajectoryInterceptionIndication")]
        pub trajectory_interception_indication: Option<SequenceOfTrajectoryInterceptionIndication>,
    ...
    impl VruMotionPredictionContainer {
        pub fn new(
            ...
            path_prediction: Option<PathPredicted>,
            safe_distance: Option<SequenceOfSafeDistanceIndication>,
            trajectory_interception_indication: Option<SequenceOfTrajectoryInterceptionIndication>,
